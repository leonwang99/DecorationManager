...
public class BookListActivity extends Activity {
	...
	final String[] booklist01=new String[]{
			"装修流程介绍","比较详细的装修流程图","室内装修具体流程","史上最全装修流程","新房装修流程"
			};//book001~book005
			
	final String[] booklist02=new String[]{
			"新房验房注意事项(详细步骤教你如何验房)","精装修验房注意事项有哪些","毛坯房装修步骤(珍藏版 赶紧收藏了！)","验房工具有哪些(9类验房工具用法)","验房注意事项(毛坯房、新房、精装房、二手房验房大全)","收房验房的步骤及注意事项",
			"新房验房注意事项大全"
			};//book006~book0012	
		
	final String[] booklist03=new String[]{
			"如何选择装修公司","选择装饰公司应该注意什么？","怎么选择装修公司秘籍","装修公司的选择","怎样选择家装公司？","如何选择装修公司?从菜鸟到专家的十二个秘诀",
			"如何选择装修公司"
			};//book0013~book0019	
